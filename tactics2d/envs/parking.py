...
class ParkingEnv(gym.Env):
    ...
    def _get_rewards(self):
        ...
        time_penalty = - np.tanh(self.scenario_manager.n_step / self.scenario_manager.max_step)
        ...
        curr_dist = Point(curr_state.location).distance(Point(self.scenario_manager.target_state.location))
        prev_dist = Point(prev_state.location).distance(Point(self.scenario_manager.target_state.location))
        distance_reward = (prev_dist - curr_dist) / self.scenario_manager.dist_norm_ratio

        curr_angle_diff = truncate_angle(curr_state.heading - self.scenario_manager.target_state.heading)
        prev_angle_diff = truncate_angle(prev_state.heading - self.scenario_manager.target_state.heading)
        angle_reward = (prev_angle_diff - curr_angle_diff) / self.scenario_manager.angle_norm_factor
