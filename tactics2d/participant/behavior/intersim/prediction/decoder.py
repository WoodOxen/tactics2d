...
class Decoder(nn.Module):
    ...
    def forward(self, mapping: List[Dict], batch_size, lane_states_batch: List[torch.Tensor], inputs: torch.Tensor,
                inputs_lengths: List[int], hidden_states: torch.Tensor, device):
        """
