        ...
        while open_set and i < max_iter:
            ...
            if callback is not None:
                ...
                state = {
                    ...
                    "f_score": f_score.copy(),  # copy of the full array
            ...
            if current_idx == target_idx:
                ...
                if callback is not None:
                    ...
                    state = {
                        ...
                        "f_score_current": f_score[target_idx],
            ...
            for neighbor in neighbors:
                ...
                if tentative_g_score < g_score[neighbor]:
                    ...
                    # Convert neighbor index to [x, y] format for heuristic function
                    x = neighbor % width
                    y = neighbor // width
                    f_score[neighbor] = g_score[neighbor] + heuristic_fn([x, y], target_rasterized)
